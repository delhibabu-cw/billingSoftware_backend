...
const create = Joi.object({
  ...
  clientId: Joi.string().required().error(commonService.getValidationMessage),
...
module.exports = {
  validateSubRoleCreate: async (dataToValidate) => validateFunc(create, dataToValidate),
  validateSubRoleUpdate: async (dataToValidate) => validateFunc(update, dataToValidate),
};
